...
export default function HubsPage() {
    ...
    const filteredHubs = hubs.filter(hub => {
        // Filter by tab type
        if (activeTab === "projects" && hub.type !== "Project") return false;
        if (activeTab === "clubs" && hub.type !== "Club") return false;
    ...
    const projects = filteredHubs.filter(hub => hub.type === "Project");
    const clubs = filteredHubs.filter(hub => hub.type === "Club");
                ...
                <div className="px-6 py-4">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex gap-2">
                            {activeTab === "projects" && <CreateProjectModal onProjectCreated={loadHubs} />}
                            {activeTab === "clubs" && (
            ...
            <div className="flex-1 p-6">
                ...
                <Tabs value={activeTab} className="w-full">
                    ...
                    <TabsContent value="clubs">
                        <Card className="p-12 text-center">
                            <h3 className="text-lg font-semibold mb-2">Clubs Coming Soon</h3>
                            <p className="text-muted-foreground">
                                Club functionality will be available in the next update.
                            </p>
                        </Card>
                    </TabsContent>
                    ...
                    <TabsContent value="my">
                        <Card className="p-12 text-center">
                            <h3 className="text-lg font-semibold mb-2">My Hubs</h3>
                            <p className="text-muted-foreground">
                                View and manage your created projects and joined clubs.
                            </p>
                        </Card>
                    </TabsContent>
                </Tabs>
